    ...
    <footer className="bg-[#1A1A1A] text-white pt-16 pb-12 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-md">
              America\'s premier residential and commercial concrete contractor. Engineered 4,000+ PSI mixes, laser-guided screed flatwork, stamped architectural finishes, and family-owned integrity since 2011.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              <li>
                <a href="#services" className="hover:text-[#F58220] transition-colors flex items-center gap-1">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-400">
              <li>
                <a href="#cad-estimator" className="hover:text-[#F58220] transition-colors flex items-center gap-1 font-semibold text-gray-200">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> CAD Concrete Estimator
                </a>
              </li>
              <li>
                <a href="#photo-estimator" className="hover:text-[#F58220] transition-colors flex items-center gap-1 font-semibold text-gray-200">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> Photo Vision Estimator
                </a>
              </li>
              <li>
                <a href="#customer-portal" className="hover:text-[#F58220] transition-colors flex items-center gap-1">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> Live Customer Portal
                </a>
              </li>
              <li>
                <a href="#fleet" className="hover:text-[#F58220] transition-colors flex items-center gap-1">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> Branded Fleet Showcase
                </a>
              </li>
              <li>
                <a href="#warranty-center" className="hover:text-[#F58220] transition-colors flex items-center gap-1">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> Warranty Center & Claims
                </a>
              </li>
              <li>
                <a href="#financing" className="hover:text-[#F58220] transition-colors flex items-center gap-1">
                  <ChevronRight className="w-3 h-3 text-[#F58220]" /> Monthly Financing ($0 Down)
                </a>
              </li>
              <li>
                <Link to="/admin" className="hover:text-[#F58220] transition-colors flex items-center gap-1 text-[#F58220] font-bold">
            ...
            <div className="space-y-3 text-xs text-gray-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  <a href="tel:3169930376" className="hover:text-[#F58220] font-bold text-white">(316) 993-0376</a>
                  <a href="tel:3162499873" className="hover:text-[#F58220] font-bold text-white">(316) 249-9873</a>
                </div>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <p>© {new Date().getFullYear()} Lara Concrete LLC. All rights reserved. Built for maximum CRO & Local SEO performance.</p>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1A1A1A] border border-white/20 rounded-xl p-6 max-w-2xl w-full text-white text-xs font-mono max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4 pb-2 border-b border-white/10">
              <h3 className="text-sm font-bold text-[#F58220]">sitemap.xml (Auto-Generated SEO Index)</h3>
              <button onClick={() => setSitemapOpen(false)} className="text-gray-400 hover:text-white font-bold">✕ Close</button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1A1A1A] border border-white/20 rounded-xl p-6 max-w-xl w-full text-white text-xs font-mono">
            <div className="flex justify-between items-center mb-4 pb-2 border-b border-white/10">
              ...
              <button onClick={() => setRobotsOpen(false)} className="text-gray-400 hover:text-white font-bold">✕ Close</button>
            </div>
