...
import { X, Send, Sparkles, Globe, User } from 'lucide-react';
...
export const BilingualAIChatbot: React.FC = () => {
  ...
  return (
    <div className="fixed top-16 right-3 sm:top-20 sm:right-6 z-50 w-[calc(100vw-1.5rem)] max-w-sm sm:max-w-md bg-[#1A1A1A] text-white rounded-2xl border border-white/20 shadow-2xl overflow-hidden flex flex-col h-[460px] sm:h-[500px] animate-fadeIn">
      {/* Header */}
