...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addLead({
      ...
      estimatedBudget: Number(formData.estimatedSqFt) * 12.50,
  ...
  return (
    <section id="contact" className="py-20 bg-[#2D2D2D] text-white relative border-b border-white/10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <p className="text-gray-300 text-base sm:text-lg">
            Ready to pour your new driveway, patio, or foundation? Fill out the form below or call our dispatch hotline directly.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 bg-[#1A1A1A] p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl space-y-6">
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h3 className="text-2xl font-black text-white">Thank You, {formData.customerName}!</h3>
                <p className="text-xs text-gray-300 max-w-md mx-auto leading-relaxed">
                  Your quote request has been routed to senior estimator Carlos Lara. We will contact you via <strong>{formData.preferredContact}</strong> within 15 minutes.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">Full Name *</label>
                    <input
                      type="text"
                      required
                  ...
                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">Phone Number *</label>
                    <input
                      type="tel"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">Email Address</label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">City / Location</label>
                    <select
                      value={formData.city}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">Concrete Service Needed</label>
                    <select
                    ...
                    >
                      ...
                      <option value="Concrete Repair & Resurfacing">Concrete Repair / Overlay</option>
                    </select>
                  </div>

                  <div>
                    <label className="block text-xs font-extrabold text-gray-300 mb-1">Est. Area (Sq Ft)</label>
                    <input
                      type="number"
                ...
                <div>
                  <label className="block text-xs font-extrabold text-gray-300 mb-1">Preferred Contact Method</label>
                  <div className="grid grid-cols-3 gap-2">
                    {(['Call', 'SMS', 'Email'] as const).map((method) => (
                      ...
                      >
                        {method === 'Call' ? 'Phone Call' : method === 'SMS' ? 'Text / SMS' : 'Email'}
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <label className="block text-xs font-extrabold text-gray-300 mb-1">Project Details / Notes</label>
                  <textarea
                    rows={3}
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#1A1A1A] p-6 rounded-2xl border border-white/10 space-y-4">
              ...
              <div className="space-y-3 text-xs">
                <a href="tel:3169930376" className="flex items-center gap-3 bg-[#2D2D2D] p-3 rounded-xl border border-white/10 hover:border-[#F58220] transition-colors">
                  <div className="w-10 h-10 rounded-lg bg-[#F58220] text-white flex items-center justify-center shrink-0">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="text-gray-400 font-bold block text-[10px] uppercase">Phone Line 1</span>
                    <span className="text-base font-black text-white">(316) 993-0376</span>
                  </div>
                </a>

                <a href="tel:3162499873" className="flex items-center gap-3 bg-[#2D2D2D] p-3 rounded-xl border border-white/10 hover:border-[#F58220] transition-colors">
                  ...
                  <div>
                    <span className="text-gray-400 font-bold block text-[10px] uppercase">Phone Line 2</span>
                ...
                <div className="bg-[#2D2D2D] p-3 rounded-xl border border-white/10 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-bold text-white">4100 E 21st St, Wichita, KS 67208</span>
                  </div>
                </div>
              </div>
            </div>
