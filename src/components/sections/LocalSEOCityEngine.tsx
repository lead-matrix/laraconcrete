      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <p className="text-gray-300 text-base sm:text-lg">
            Click on your city below to inspect local job completion metrics, average driveway
            costs, and fast dispatch times.
          </p>
          ...
          <div className="lg:col-span-7 space-y-5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-gray-400 font-medium">
                ZIP Codes: {activeCity.zipCodes.join(', ')}
              </span>
            </div>

            <h3 className="text-3xl sm:text-4xl font-black text-white">
              #1 Concrete Contractor in{' '}
            ...
            <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
              Lara Concrete LLC mobilizes heavy equipment, 4,000+ PSI concrete mixers, and certified
              finishing crews directly to {activeCity.name} homeowners and commercial property
              managers.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
              ...
              <div className="bg-[#1A1A1A] p-3 rounded-xl border border-white/5">
                ...
                <p className="text-xl font-black text-emerald-400">
                  &lt; {activeCity.dispatchTimeHours} Hours
                </p>
              </div>
              <div className="bg-[#1A1A1A] p-3 rounded-xl border border-white/5">
            ...
            <div className="pt-2">
              <button
                onClick={() =>
                  openEstimateModal(
                    `Local Estimate Request: ${activeCity.name}, ${activeCity.state}`
                  )
                }
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-xl overflow-hidden bg-[#121212] border border-white/20 h-72 shadow-xl group">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <span className="text-[10px] text-[#F58220] font-black uppercase tracking-widest block">
                  Featured {activeCity.name} Project
                </span>
                <span className="text-sm font-black text-white block">
                  {activeCity.featuredProjectTitle}
                </span>
              </div>
            </div>
          </div>
