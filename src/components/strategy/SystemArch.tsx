  ...
  const nodes = [
    {
      ...
      details:
        'Client visits a mobile-optimized lander. Static site builds run on Cloudflare edge routing, loading page structure under 0.8s. Quick loading avoids 22% attic bounce drop-off.',
      icon: Laptop,
    ...
    },
    {
      ...
      details:
        'Contact data maps dynamically to serverless endpoint webhooks. Processing time takes less than 1.2s, filtering spam calls and formatting payloads before storing to database.',
      icon: Cpu,
    ...
    },
    {
      ...
      details:
        "An AI parses customer logs (e.g. 'pipe burst and flooded first floor') to evaluate urgency. Emergency alerts are triaged instantly; standard requests follow standard schedules.",
      icon: Brain,
    ...
    },
    {
      ...
      tech: 'Twilio SMS API',
      details:
        'Twilio routes critical lead alerts straight to regional technician mobile units using SMS payloads containing job values and geographic links.',
      icon: MessageSquare,
    ...
    },
    {
      ...
      details:
        'The closest technician reviews and accepts bookings via SMS. Dispatch is complete. Total speed-to-lead latency: under 45 seconds.',
      icon: ShieldCheck,
    ...
    <div className="glass-panel rounded-3xl p-6 md:p-8 border border-white/5 space-y-8">
      <div>
        ...
        <p className="text-xs text-gray-400">
          Click any architecture node to see details of how our system completes dispatch in under
          45 seconds.
        </p>
      </div>
      ...
      >
        ...
        <h4 className="font-display font-bold text-lg text-white">{nodes[activeNode].title}</h4>
